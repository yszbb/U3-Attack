...
#     "../checkpoints/stable-diffusion-xl-1.0-inpainting-0.1",
...
def main(input_path, pipe_inpaint, detector, universal):
    ...
    # save_path_ = "black_save_pictures/adv_sdxl1.0_{}_patch".format(ind_patch)
    save_path_ = "black_save_pictures/adv_sd2_{}_patch".format(ind_patch)
    ...
    for ind in range(61):
        ...
        #     # generator=generator,
        # )
        content = pipe_inpaint(prompt=[prompt] * 4, image=picture_adv, mask_image=mask_image, num_inference_steps=100)
